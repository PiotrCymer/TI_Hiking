<form class="form-signin text-center" method="post" id="signInForm">
    ...
    <div id="spinner"></div>
    <button class="btn btn-lg btn-primary btn-block w-100" type="submit" id="signInBtn">Zaloguje się</button>
    <h6 class="mt-2">Jeżeli nie posiadasz konta <a href="/rejestracja">Kliknij tutaj</a> aby się zarejestrować!</h6>
</form>
